...
def stations_in_arps_domain(stanames, latlon_model):
    """
...
latgrid = pd.read_csv('/home/thomas/phd/statmod/data/model_data/latgrid.csv', index_col=0).T
longrid = pd.read_csv('/home/thomas/phd/statmod/data/model_data/longrid.csv', index_col=0).T
ZP = pd.read_csv('/home/thomas/phd/statmod/data/model_data/ZP.csv', index_col=0).T
latlon_model = pd.read_csv("/home/thomas/phd/statmod/data/model_data/latlon.csv", index_col=0, parse_dates=True)


stanames = loading_true.index
stalatlons = stations_in_arps_domain(stanames,latlon_model)
idx_sta_in_model = find_idxs_at_stations_positions(latgrid, longrid, stalatlons)

#===============================================================================
# TEST plot temperature
#===============================================================================
Tk = pd.HDFStore('/home/thomas/phd/statmod/data/model_data/newTk_store.h5')
...
Tk_at_stations.index = idx_sta_in_model.index
